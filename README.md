...
<table>
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <p>Six merged PRs in the security, test, cron, and gateway paths of ZeroClaw, including a fail-closed fix to the Verifiable Intent constraint checker that shipped in v0.8.4. 20 artifacts filed upstream: 9 PRs and 11 issues.</p>
      <p>
        <img src="https://img.shields.io/badge/Rust-000?style=flat-square&logo=rust&logoColor=white" alt="Rust" />
      </p>
...
<p align="center">
  <img src="quote.svg" alt="They said nobody could do it. So Nobody did. — Outis" />
</p>
